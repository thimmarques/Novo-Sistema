      ...
      <div className="bg-card rounded-lg border border-border p-6">
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div className="col-span-2">
            <h2 className="text-sm font-semibold text-foreground mb-4 pb-2 border-b border-border/50">Informações do Processo</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-muted rounded-lg p-4">
              ...
              <p className="text-sm text-secondary-foreground italic">{proc.notes || 'Nenhuma observação.'}</p>
            </div>
          </div>
        </div>
      </div>
