...
const sectionTitle = 'text-sm font-semibold text-foreground mb-4 pb-2 border-b border-border/50 col-span-2';
...
const areaOptions: { value: PracticeArea; label: string; selectedCls: string }[] = [
  ...
  { value: 'civil', label: 'Civil', selectedCls: 'bg-badge-civil border-badge-civil text-badge-civil-foreground' },
  { value: 'criminal', label: 'Criminal', selectedCls: 'bg-badge-criminal border-badge-criminal text-badge-criminal-foreground' },
  { value: 'previdenciario', label: 'Previdenciário', selectedCls: 'bg-badge-previdenciario border-badge-previdenciario text-badge-previdenciario-foreground' },
];
          ...
          <div className="flex gap-3">
            ...
            {step === 1 ? (
              <button
                ...
                className="flex items-center gap-1 bg-primary text-white text-sm font-medium rounded-md px-6 py-2 hover:bg-primary/90 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
              >
                Próximo
  ...
  return (
    <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex gap-4">
              {[
                ...
                <label key={o.v} className="flex items-center gap-2 cursor-pointer">
                  <input type="radio" name="polo" value={o.v} checked={form.polo === o.v} onChange={() => set('polo', o.v)} className="accent-primary" />
                  <span className="text-sm text-foreground/80">{o.l}</span>
                </label>
              ))}
            </div>
          </Field>
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              <button
                ...
                className={`relative inline-flex h-5 w-9 shrink-0 rounded-full transition-colors ${
                  form.antecedentes_criminais ? 'bg-destructive' : 'bg-secondary'
                }`}
              >
              ...
              <span className="text-sm text-foreground/80">Possui antecedentes criminais</span>
            </label>
          </Field>
        </>
      )}
            ...
            <div className="flex gap-6">
              <label className="flex items-center gap-3 cursor-pointer">
                <button
                  ...
                  className={`relative inline-flex h-5 w-9 shrink-0 rounded-full transition-colors ${
                    form.cnis_disponivel ? 'bg-badge-ativo' : 'bg-secondary'
                  }`}
                >
                ...
                <span className="text-sm text-foreground/80">CNIS disponível</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer">
                <button
                  type="button"
                  ...
                  className={`relative inline-flex h-5 w-9 shrink-0 rounded-full transition-colors ${
                    form.pericia_medica ? 'bg-badge-pendente' : 'bg-secondary'
                  }`}
                >
                ...
                <span className="text-sm text-foreground/80">Perícia médica necessária</span>
              </label>
            </div>
          </Field>
        </>
      ...
      {/* ══════════════════════════════
         COMMON FIELDS
         ══════════════════════════════ */}
      <div className="col-span-2 border-t border-border/50 mt-4 pt-4" />
      ...
      <Field label="" colSpan={2}>
        <label className="flex items-center gap-3 cursor-pointer">
          ...
          <span className="text-sm text-foreground/80">Marcar como cliente VIP</span>
          <button
            type="button"
            role="switch"
            ...
            className={`relative inline-flex h-5 w-9 shrink-0 rounded-full transition-colors ml-auto ${
              form.is_vip ? 'bg-badge-pendente' : 'bg-secondary'
            }`}
          >
